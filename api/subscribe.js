    ...
    if (process.env.BREVO_API_KEY) {
      const analysisHtml = analysis ? `
        ...
        <div style="margin-bottom: 28px;">
          <p style="font-family: Georgia, serif; font-size: 16px; font-weight: 600; color: #45543B; margin: 0 0 12px;">Start het gesprek</p>
          ...
          htmlContent: `
            <div style="font-family: 'Helvetica Neue', sans-serif; max-width: 560px; margin: 0 auto; color: #332D28;">
              ...
              <div style="background: #F5F3EF; padding: 32px; border-radius: 0 0 12px 12px;">
                <p style="font-size: 15px; line-height: 1.7; color: #766960; margin: 0 0 28px;">Hoi ${name || 'daar'}, hieronder vind je jouw persoonlijke analyse.</p>
                ${analysisHtml}
                <div style="background: #45543B; border-radius: 10px; padding: 24px; text-align: center; margin-top: 8px;">
                  <p style="font-family: Georgia, serif; font-size: 12px; letter-spacing: 0.08em; text-transform: uppercase; color: #EFEBE7; margin: 0 0 10px;">Van diagnose naar beweging</p>
                  <p style="font-family: Georgia, serif; font-size: 20px; color: #F5F3EF; margin: 0 0 8px; line-height: 1.3;">Je weet nu waar energie lekt in jullie team.</p>
